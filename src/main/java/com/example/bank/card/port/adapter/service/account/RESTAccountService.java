package com.example.bank.card.port.adapter.service.account;
...
import com.example.bank.card.domain.model.account.AccountId;
import com.example.bank.card.domain.model.account.AccountService;
import com.example.bank.card.domain.model.account.AccountType;
import com.example.bank.card.domain.model.account.transaction.Transaction;
import com.example.bank.card.domain.model.account.transaction.TransactionId;
import com.example.bank.card.domain.model.account.transaction.TransactionStatus;
import com.example.bank.card.domain.model.currency.CurrencyCode;
import com.example.bank.card.domain.model.money.Money;
import com.example.bank.card.port.adapter.service.account.transaction.TransactionRequest;
import com.example.bank.card.port.adapter.service.account.transaction.TransactionResponse;
